...
DEFAULT_CONFIG_FILE = "/home/lenni/git/i3scripts/icons.ini"
...
if __name__ == '__main__':
    ...
    def tick_event_handler(i3, e):
        if e.payload == "reload_wins":
            rename_workspaces(i3, icon_list_format=args.icon_list_format)

    i3.on('window', event_handler)
    i3.on('workspace::move', event_handler)
    i3.on('tick', tick_event_handler)
    i3.main()
